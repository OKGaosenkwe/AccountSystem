...
public class CustomerInfo implements Serializable {
    ...
    private Set<za.ac.nwu.domain.persistence.CustomerInfo> CustomerInfo;

    public CustomerInfo() {
    }

    public CustomerInfo(String name, String lastName, String ID, String email, int miles, String reward_voucher) {
        Name = name;
        LastName = lastName;
        this.ID = ID;
        this.email = email;
